  ...
  return (
    <div className="flex flex-col h-full bg-white overflow-hidden text-sm">
      ...
      <div className="p-4 border-b border-slate-200 bg-slate-50 flex justify-between items-center shrink-0">
        <div>
          <h2 className="font-bold text-slate-800 text-base">Inspeção CMM & Metrologia</h2>
          <span className="text-xs text-slate-500 font-medium">Especificação ASME Y14.5</span>
        </div>
